...
<body>
    ...
    <div class="content">
        <h2 class="dashboard-title">Chỉnh Sửa Nhà Cung Cấp</h2>
        <form action="/SpringMVCPagination/nklnhacungcap/nkleditsave" method="post">
            <input type="hidden" name="nklIdNCC" value="${command.nklIdNCC}">

            <div class="form-group">
                <label>Tên Nhà Cung Cấp:</label>
                <input type="text" class="form-control" name="nklTenNCC" value="${command.nklTenNCC}" required>
            </div>

            <div class="form-group">
                <label>Địa Chỉ:</label>
                <input type="text" class="form-control" name="nklDiaChi" value="${command.nklDiaChi}" required>
            </div>
            ...
            <div class="btn-group">
                ...
                <a href="/SpringMVCPagination/nklnhacungcap/nklview" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Hủy</a>
            </div>
        </form>
    </div>
</body>
